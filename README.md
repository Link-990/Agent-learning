...
早期的 `01-python基础`、`02-大模型基本框架`、`03-RAG`、`04-Agent`、`05-MCP`、`06-Skills`、`07-微调`、`08-强化学习`、`09-主流Agent框架` 以及 10–17 号专题目录已经完成内容迁移并从仓库移除。新的学习请从上面的 canonical 目录开始；Runtime 的旧命令入口仍保留在 `runtime-course/`。
