...
| 准备 Agent 面试 | [Agent 核心组件](04-Agent/01-Agent核心组件.md) → [面试技巧专题](10-面试技巧/00-README.md) |
| 理解工具生态 | [MCP](05-MCP/README.md) → [Skills](06-Skills/README.md) |
| 复习训练与对齐 | [微调](07-微调/README.md) → [强化学习](08-强化学习/README.md) |

## 面试技巧专题

所有面试稿、飞书场景、系统设计题和模拟面试内容统一放在一个入口，避免和基础知识目录混在一起。

| 入口 | 内容 |
| --- | --- |
| [10-面试技巧](10-面试技巧/00-README.md) | Agent 基础、飞书 Agent 场景、RAG 企业知识库、工具调用、工程化、系统设计、项目深挖和附录 |
...
| [面试技巧](10-面试技巧/00-README.md) | 面向面试复述的专题扩展、企业场景和系统设计 |
