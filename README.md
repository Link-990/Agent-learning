...
这部分内容已按面试学习顺序放在仓库根目录，适合直接从专题入口阅读。原有的 RAG、Agent、MCP 和 Skills 基础专题继续保留，飞书专题在此基础上补充企业协作场景、工程化和系统设计。

| 顺序 | 专题 | 重点内容 |
| --- | --- | --- |
| 10 | [Agent 基础](10-Agent基础/01-Agent基础.md) | Agent、LLM、Workflow、Agent Loop、推理范式、记忆与上下文、Multi-Agent |
| 11 | [飞书 Agent 场景设计](11-飞书Agent场景设计/) | 知识问答、会议纪要、审批、表格分析、消息与员工助手 |
| 12 | [RAG 与企业知识库](12-RAG与企业知识库/) | 飞书文档、知识库、云盘、多维表格接入，检索、权限和评测 |
| 13 | [工具调用与飞书开放能力](13-工具调用与飞书开放能力/) | Function Calling、MCP、API、Webhook、事件订阅与卡片交互 |
| 14 | [企业级 Agent 工程化](14-企业级Agent工程化/) | 多租户、授权、数据权限、安全、成本、可观测性与灰度发布 |
| 15 | [系统设计题](15-系统设计题/) | 企业知识问答、审批助手、跨文档分析、多 Agent 和上线方案 |
| 16 | [项目深挖与模拟面试](16-项目深挖与模拟面试/) | 架构、选型、失败复盘、指标体系和完整示范回答 |
| 17 | [附录](17-附录/) | 术语表、流程图、接口示例、题目索引与参考资料 |

详细使用说明见[飞书 Agent 面试专题说明](10-飞书Agent面试-README.md)。
